...
Local $app_name = "Janison Staging Environment"
...
$storage_format = '<a href=\"https://janisoncls.atlassian.net/wiki/download/attachments/494207048/Janison%20Staging%20Environment%20portable.exe\">Click to update page</a><br /><br />'
...
Local $deployment = _OctopusGetLatestTenantIdsDeploymentIdTaskIdCreatedForEnvironment("Environments-28")
...
Local $subscription_arr[1]
$subscription_arr[0] = "AssessmentDevTest"
...
for $subscription_num = 0 to (UBound($subscription_arr) - 1)
	...
	ConsoleWrite('@@ Debug(' & @ScriptLineNumber & ') : $subscription_name = ' & $subscription_name & @CRLF & '>Error code: ' & @error & @CRLF) ;### Debug Console
	...
	$ps_script_arr[1] = "Get-AzureRmResource -ResourceType 'Microsoft.Sql/servers' -ResourceGroupName '*-SIT'"
...
Update_Confluence_Page("https://janisoncls.atlassian.net", "JAST", "495845841", "495747625", "Staging Environment", $storage_format)
